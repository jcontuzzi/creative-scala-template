...
object Chapter2Exercises {
  ...
  val test = triangle(40,60).fillColor(Color.yellow.spin(doodle.core.Angle.degrees(30)))
...
object Chapter3Exercises {
  ...
  val exercise4 = circle(10).fillColor(Color.red).on(circle(20)).on(circle(30).fillColor(Color.red)).above(rectangle(10,30).lineWidth(3).above(rectangle(30,10).fillColor(Color.brown).above(rectangle(150,40).fillColor(Color.green))))
}
